...
class Simulator():
    def __init__(self, world: natura.World, tick_function = None):
        self.world = world
        ...
        self.pop.add_reporter(neat.Checkpointer(tick_function, None, './saves/gen-'))
        self.pop.add_reporter(neat.StdOutReporter(True))
        self.delta = 0.03
    
    def start(self, generations = None):
    ...
    def eval_genomes(self, genomes: list, config: neat.Config):
        ...
        while True:
            ...
            tick_count += 1
            if self.tick_function: self.delta = self.tick_function(population)